...
//        int availableWidth = mDial.getIntrinsicWidth();///2;
//        int availableHeight = mDial.getIntrinsicHeight();///2;
      ...
      */
//        Bitmap bitmap = ((BitmapDrawable) mDial).getBitmap();
//        Drawable d = new BitmapDrawable(getResources(), Bitmap.createScaledBitmap(bitmap, 440, 440, false));
//
//        final Drawable dial = d;
...
//        final Drawable minuteHand = mDial;
        ...
        if(mSecondHand!=null) {
        if (seconds) {
//            final Drawable mSecHand = mDial;
            final Drawable mSecHand = mSecondHand;
            w = mSecHand.getIntrinsicWidth()*2;
            h = mSecHand.getIntrinsicHeight()*2;
