...
public class DigitalClock2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
      ...
      //  mMinute = calendar.get(java.util.Calendar.MINUTE);
        ...
        String date=calendar.get(java.util.Calendar.DAY_OF_MONTH)+"/"+ (calendar.get(Calendar.MONTH)+1);
        Log.d("Date_Clock","Clock 2 : format -> "+date);
    ...
    private void setDay(Canvas canvas, String s) {
        ...
        canvas.drawText(s,(getWidth()/2)-70,750,paint);
    }

    private void setDate(Canvas canvas, String date) {

        setPaintAttributes(Color.parseColor("#2680EB"), Paint.Style.FILL, 10, 80f,20);
        canvas.drawText(date,(getWidth()/2)-70,400,paint);
    }
    ...
    public void setHours(Canvas canvas, float location) {
        ...
        if (length < 2) {
            canvas.drawText("0" + (int) (location / 5), (getWidth() / 2) - 250, 600, paint);
        } else {
            canvas.drawText((int) (location / 5) + "", (getWidth() / 2) - 250, 600, paint);
        }
    ...
    public void setColun(Canvas canvas) {
        ...
        canvas.drawText(" ", (getWidth() / 2) - 30, 600 - 10, paint);
        if (blink)
            canvas.drawText(":", (getWidth() / 2) - 30, 600 - 10, paint);
    }
    ...
    public void setMinute(Canvas canvas, float location) {
        ...
        if (length < 2) {
            canvas.drawText("0" + (int) location, (getWidth() / 2)+20 , 600, paint);
        } else {
            canvas.drawText((int) location + "", (getWidth() / 2)+20,600, paint);
        }
    }
...
//        paint.setShadowLayer(radius,0,0,Color.RED);
        paint.setTypeface(ResourcesCompat.getFont(mContext, R.font.digital_italic));
    }
