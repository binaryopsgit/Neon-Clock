...
public class DigitalClockService2 extends WallpaperService {
    @Override
       ...
       // private List<MyPoint> circles;
        ...
        public DigitalClock() {
            ...
            SharedPreferences prefs = PreferenceManager
                    .getDefaultSharedPreferences(DigitalClockService2.this);
            maxNumber = Integer
         ...
         //   circles = new ArrayList<MyPoint>();
            ...
            spRipple= PreferenceManager.getDefaultSharedPreferences(DigitalClockService2.this);
...
//            canvas.drawColor(Color.BLACK);
        ...
        private void setPaintAttributes(int colour, Paint.Style stroke, int strokeWidth, float size) {
            ...
            paint.setTypeface(ResourcesCompat.getFont(DigitalClockService2.this, R.font.ds_digital));
        }
...
//            paint.setShadowLayer(radius,0,0,Color.RED);
            paint.setTypeface(ResourcesCompat.getFont(DigitalClockService2.this, R.font.digital_italic));
        }
...
//                    canvas.drawColor(Color.BLACK);
      ...
      /*  public void setSecond(Canvas canvas, float location) {
        ...
        private void setPaintAttributes(int colour, Paint.Style stroke, int strokeWidth, float size,int radius,int shadowcolor,int font) {
            ...
            paint.setTypeface(ResourcesCompat.getFont(DigitalClockService2.this, font));
        }
        ...
        private void draw() {
            ...
            try {
                ...
                /*    if (circles.size() >= maxNumber) {
                    ...
                    //setSecond(canvas, mSecond);
                    String date=calendar.get(Calendar.DAY_OF_MONTH)+"/"+Calendar.MONTH+"/"+calendar.get(Calendar.YEAR);
                    int day=calendar.get(Calendar.DAY_OF_WEEK);
                    String zone="none";
                    if(calendar.get(Calendar.AM_PM)==Calendar.PM){
                        zone="PM";
