...
public class AnalogClockService1 extends WallpaperService {
    @Override
    public Engine onCreateEngine() {
        ...
        Drawable presentDrawable=getResources().getDrawable(R.drawable.ic_dial_clock5);

        Log.d("Drawable","dial : height "+mDial.getIntrinsicHeight());
        Log.d("Drawable","dial : width "+mDial.getIntrinsicWidth());
        Log.d("Drawable","presentDrawable : height "+presentDrawable.getIntrinsicHeight());
        Log.d("Drawable","presentDrawable : width "+presentDrawable.getIntrinsicWidth());
    ...
    private class AnalogClock1 extends Engine {
        ...
        public AnalogClock1(Drawable dial,Drawable hour,Drawable minute,Drawable second) {
            ...
            SharedPreferences prefs = PreferenceManager
                    .getDefaultSharedPreferences(AnalogClockService1.this);
            maxNumber = Integer
            ...
            clock = new SaadClock(AnalogClockService1.this, attributeSet, 0);
...
//                    canvas.drawColor(Color.BLACK);
                   ...
                   /* compass = new Compass(AnalogClockService1.this);
                    compass.start();
...
//                    allvalues[5] = (height / mScreenHeight) * mScreenWidth;
                    allvalues[6] = 0.0f;
                    allvalues[7] = 0.0f;
                    allvalues[8] = 1.0f;
...
//                    canvas.drawBitmap(bitmap, (mScreenWidth/2),(mScreenHeight/2), paint);
        ...
        public class SaadClock extends View {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                try {
                    ...
                    Log.d("Canvas_clock", "layout width: " + getWidth());
                    Log.d("Canvas_clock", "layout height: " + getHeight());

                    Log.d("Canvas_clock", "canvas width: " + canvas.getWidth());
                    Log.d("Canvas_clock", "canvas height: " + canvas.getHeight());

                    Log.d("Canvas_clock", "availableWidth: " + availableWidth);
                    Log.d("Canvas_clock", "availableHeight: " + availableHeight);
                ...
                canvas.drawText(dayofWeek, (x - (box_w / 2)) + xval, (y - (box_h / 2)) + yval_text2, paint2);*/
                    ...
                    Log.d("Canvas_clock", "clock width: " + w);
                    Log.d("Canvas_clock", "clock height: " + h);
...
//                    scaled = true;
//                    float scale = Math.min((float) (ClockUtils.Companion.getMobileScreenWidth()/2) / (float) w,
//                            (float) (ClockUtils.Companion.getMobileScreenHeight()/2) / (float) h);
//                    canvas.save();
////                    canvas.scale(scale, scale, x, y);
